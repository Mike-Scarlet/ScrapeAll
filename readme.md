...
scrape_all/    核心包
  ...
  sites/       站点封装
    ...
    eroscripts/ eroscripts.com（discourse）tag 列表 collect
...
python scripts/scrape_eroscripts.py # eroscripts collect：翻 tag 列表（站内 JSON，bumped_at 序）到 cutoff/已覆盖边界，topic 落库
